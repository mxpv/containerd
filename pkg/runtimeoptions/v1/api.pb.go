...
type Options struct {
	...
	//	*Options_ConfigPath
	//	*Options_Blob
	Source isOptions_Source `protobuf_oneof:"source"`
}
...
func (m *Options) GetSource() isOptions_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (x *Options) GetConfigPath() string {
	if x, ok := x.GetSource().(*Options_ConfigPath); ok {
		return x.ConfigPath
	}
	return ""
}

func (x *Options) GetBlob() []byte {
	if x, ok := x.GetSource().(*Options_Blob); ok {
		return x.Blob
	}
	return nil
}

type isOptions_Source interface {
	isOptions_Source()
}

type Options_ConfigPath struct {
	// ConfigPath specifies the filesystem location of the config file
	// used by the runtime.
	ConfigPath string `protobuf:"bytes,2,opt,name=config_path,json=configPath,proto3,oneof"`
}

type Options_Blob struct {
	// Blob is an array of bytes passed directly from contaienrd's TOML config file.
	Blob []byte `protobuf:"bytes,3,opt,name=blob,proto3,oneof"`
}

func (*Options_ConfigPath) isOptions_Source() {}

func (*Options_Blob) isOptions_Source() {}
...
var file_github_com_containerd_containerd_pkg_runtimeoptions_v1_api_proto_rawDesc = []byte{
	...
	,
}
...
func file_github_com_containerd_containerd_pkg_runtimeoptions_v1_api_proto_init() {
	...
	file_github_com_containerd_containerd_pkg_runtimeoptions_v1_api_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Options_ConfigPath)(nil),
		(*Options_Blob)(nil),
	}
	type x struct{}
