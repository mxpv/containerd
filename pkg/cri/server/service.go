...
import (
	...
	"github.com/containerd/containerd/pkg/cri/server/instrument"
...
func (c *criService) register(s *grpc.Server) error {
	instrumented := instrument.NewInstrumentedService(c)
	runtime.RegisterRuntimeServiceServer(s, instrumented)
	runtime.RegisterImageServiceServer(s, instrumented)
	instrumentedAlpha := instrument.NewInstrumentedAlphaService(c)
